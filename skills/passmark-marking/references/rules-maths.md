...
- **ft / FT** (follow through): award if the student's work is correct *given their own earlier wrong value*. Check their arithmetic from their value.
...
- **SC** (special case): only when the student's route matches the special-case description.
...
- **B1ft**, **A1ft**: as ft above, on the student's own earlier value.
